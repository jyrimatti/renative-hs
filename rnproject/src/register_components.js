...
module.exports = (function() {
    // Components (corresponds to those in Components.hs)
    window['ActivityIndicator'] = __rn.ActivityIndicator;
    window['Button'] = __rn.Button;
    window['DatePickerIOS'] = __rn.DatePickerIOS;
    window['DrawerLayoutAndroid'] = __rn.DrawerLayoutAndroid;
    window['FlatList'] = __rn.FlatList;
    window['Image'] = __rn.Image;
    window['KeyboardAvoidingView'] = __rn.KeyboardAvoidingView;
    window['ListView'] = __rn.ListView;
    window['MaskedViewIOS'] = __rn.MaskedViewIOS;
    ...
    window['SafeAreaView'] = __rn.SafeAreaView;
    window['ScrollView'] = __rn.ScrollView;
    window['SectionList'] = __rn.SectionList;
    window['SegmentedControlIOS'] = __rn.SegmentedControlIOS;
    window['Slider'] = __rn.Slider;
    window['SnapshotViewIOS'] = __rn.SnapshotViewIOS;
    ...
    window['BackHandler'] = __rn.BackHandler;
    ...
    window['Easing'] = __rn.Easing;
    window['Geolocation'] = __rn.Geolocation;
    window['ImageEditor'] = __rn.ImageEditor;
    window['ImagePickerIOS'] = __rn.ImagePickerIOS;
    window['ImageStore'] = __rn.ImageStore;
    window['InteractionManager'] = __rn.InteractionManager;
    window['Keyboard'] = __rn.Keyboard;
    window['LayoutAnimation'] = __rn.LayoutAnimation;
    window['Linking'] = __rn.Linking;
    window['ListViewDataSource'] = __rn.ListViewDataSource;
    window['NetInfo'] = __rn.NetInfo;
    window['PanResponder'] = __rn.PanResponder;
    window['PermissionsAndroid'] = __rn.PermissionsAndroid;
    window['PixelRatio'] = __rn.PixelRatio;
    //window['PushNotificationIOS'] = __rn.PushNotificationIOS;
    window['Settings'] = __rn.Settings;
    window['Share'] = __rn.Share;
    window['StatusBarIOS'] = __rn.StatusBarIOS;
    window['StyleSheet'] = __rn.StyleSheet;
    window['Systrace'] = __rn.Systrace;
    window['TimePickerAndroid'] = __rn.TimePickerAndroid;
    window['ToastAndroid'] = __rn.ToastAndroid;
    window['Transforms'] = __rn.Transforms;
